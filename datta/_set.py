...
class ProxyPrivateSetData(
    ProxyPrivateDataCollection[PSD, T],
    ProxyImmutableSetStructure[PSD, T],
    PrivateSetData[T],
):
    """Proxy private set data."""

    __slots__ = ()


class ProxySetData(
    ProxyDataCollection[SD, T],
    ProxyPrivateSetData[SD, T],
    ProxyUserImmutableSetStructure[SD, T],
    SetData[T],
):
    """Proxy set data."""
